            ...
            <table class="table table-bordered" id="datatablesSimple">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?id=<?= $diskon['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="hapus.php?id=<?= $diskon['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach ?>
                </tbody>
